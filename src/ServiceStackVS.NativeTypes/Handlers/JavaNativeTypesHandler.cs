...
{
    public class JavaNativeTypesHandler: INativeTypesHandler
    {
        ...
        public string CodeFileExtension { get { return ".java"; } }
        public string RelativeTypesUrl { get { return "types/java"; } }
